...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  // Ultimaker
  //#define  DEFAULT_Kp 33.97
  //#define  DEFAULT_Ki 3.29
  //#define  DEFAULT_Kd 87.65

  // Frankenstein
  #define  DEFAULT_Kp 27.31
  #define  DEFAULT_Ki 2.37
  #define  DEFAULT_Kd 78.53
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define  DEFAULT_bedKp 425.95
  #define  DEFAULT_bedKi 44.33
  #define  DEFAULT_bedKd 1023.25
 ...
 *                                    { X, Y, Z, E }
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 803, 545 }
...
//#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 40), (Y_MAX_POS - 50), 50 }
#endif
